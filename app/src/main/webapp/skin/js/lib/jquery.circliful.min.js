(function(a) {
    a.fn.circliful = function(b) {
        ...
        return this.each(function() {
            ...
            F = a(this).data("twidth") != undefined?a(this).data("twidth"):c.twidth;
            var theight = a(this).data("theight") != undefined?a(this).data("theight"):null;
            ...
            var h = a("<canvas></canvas>").attr({
                width: F,
                height: theight?theight:F
            }).appendTo(a(this)).get(0);
            var f = h.getContext("2d");
            var p = h.width / 2;
            var o = theight?h.height:h.height / 2;
            var A = e * 360;
            var G = A * (Math.PI / 180);
            var j = h.width / 2.5;
            var z = 2.3 * Math.PI;
