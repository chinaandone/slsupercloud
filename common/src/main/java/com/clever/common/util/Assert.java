...
import com.clever.common.exception.CustomDataValidateException;
...
public class Assert {
    ...
    /**
     * 对一个boolean表达式进行断言,如果表达式的值为false则抛出CustomDataValidateException
     *
     * @param expression
     */
    ...
    public static void isTrue(boolean expression, String message) {
        if (!expression) {
            throw new CustomDataValidateException(message);
        }
    }
    ...
    /**
     * 如果object不为null则抛出CustomDataValidateException
     *
     * @param object
     */
    ...
    /**
     * 如果object为null则抛出CustomDataValidateException
     *
     * @param object
     */
    ...
    /**
     * 如果object不为空值(null, "", " ", "null", empty collection, empty map, empty array)则抛出CustomDataValidateException
     *
     * @param object
     */
    ...
    /**
     * 如果object为空值(null, "", " ", "null", empty collection, empty map, empty array)则抛出CustomDataValidateException
     *
     * @param object
     */
    ...
    /**
     * 如果数组array中的元素存在null值,则抛出CustomDataValidateException
     *
     * @param array
     */
    ...
    /**
     * 如果集合collection中的元素存在null值,则抛出CustomDataValidateException
     *
     */
    ...
    /**
     * 如果集合map中的元素存在value=null值,则抛出CustomDataValidateException
     *
     */
    ...
    /**
     * 如果集合map中的元素存在key=null值,则抛出CustomDataValidateException
     *
     */
    ...
    public static void isInstanceOf(Class<?> type, Object obj) {
        ...
        if (!type.isInstance(obj)) {
            throw new CustomDataValidateException("Object of class [" + (obj != null ? obj.getClass().getName() : "null") + "] must be an instance of " + type);
        }
    }
    ...
    public static void isAssignable(Class<?> superType, Class<?> subType) {
        ...
        if (subType == null || !superType.isAssignableFrom(subType)) {
            throw new CustomDataValidateException(subType + " is not assignable to " + superType);
        }
    }
