 ...
 */
@Repository
public class PathManageDaoImpl extends BaseMybatisDAO<Path, Long>  implements PathManageDao {

    private static final String sql_mapper = "com.clever.common.repository.PathManageDao";
