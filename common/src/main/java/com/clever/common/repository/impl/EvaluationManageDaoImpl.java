 ...
 */
@Repository
public class EvaluationManageDaoImpl extends BaseMybatisDAO<Evaluation, Long>  implements EvaluationManageDao {

    private static final String sql_mapper = "com.clever.common.repository.EvaluationManageDao";
    ...
    public Collection getFeelAverage(PaginationView paginationView) {
        return this.getMasterSqlSessionTemplate().selectList(getMapperKey(getNamespace(), "getAverage"),paginationView.loadListFilter());
    }
