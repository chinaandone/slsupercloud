 ...
 */
@Repository
public class SendRecordManageDaoImpl extends BaseMybatisDAO<SendRecord, Long>  implements SendRecordManageDao {

    private static final String sql_mapper = "com.clever.common.repository.SendRecordManageDao";
