 ...
 */
@Repository
public class PictrueManageDaoImpl extends BaseMybatisDAO<Pictrue, Long>  implements PictrueManageDao{

    private static final String sql_mapper = "com.clever.common.repository.PictrueManageDao";
