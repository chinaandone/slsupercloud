 ...
 */
@Repository
public class AdSequenceManageDaoImpl extends BaseMybatisDAO  implements AdSequenceManageDao {

    private static final String sql_mapper = "com.clever.common.repository.AdSequenceManageDao";
