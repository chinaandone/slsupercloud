 ...
 */
@Repository
public class VideoManageDaoImpl extends BaseMybatisDAO<Video, Long>  implements VideoManageDao {

    private static final String sql_mapper = "com.clever.common.repository.VideoManageDao";
