 ...
 */
@Repository
public class VideoPublishManageDaoImpl extends BaseMybatisDAO<VideoPublish, Long>  implements VideoPublishManageDao {

    private static final String sql_mapper = "com.clever.common.repository.VideoPublishManageDao";
