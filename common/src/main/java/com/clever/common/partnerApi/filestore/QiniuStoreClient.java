package com.clever.common.partnerApi.filestore;

import com.clever.common.client.view.UploadTokenView;
...
public class QiniuStoreClient {
	...
	private final static Logger logger = Logger.getLogger(QiniuStoreClient.class);
